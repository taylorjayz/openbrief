...
summary: |
  ...
  Use Promises for I/O and timers; keep CPU-heavy work off the main thread when UI jank matters. Prefer Promise.all when independent requests can run together, and Promise.allSettled when you need every result even if some fail.
tags: [web, software]
source:
