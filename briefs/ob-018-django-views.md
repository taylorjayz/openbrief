...
summary: |
  ...
  Pattern: one clear job per view, explicit status codes, and reuse generic class-based views when they fit without fighting them. If a class-based view needs five overrides, a function view is often clearer.
